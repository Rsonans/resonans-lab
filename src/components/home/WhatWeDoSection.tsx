...
export function WhatWeDoSection() {
  return (
    <section id="what-we-do" className="py-32 bg-muted/50 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-foreground max-w-xl">
            What We Do
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          {blocks.map((block, index) => (
            <motion.div
              ...
              className={`bg-card backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-border shadow-sm hover:shadow-md transition-shadow ${
